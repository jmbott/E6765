...
# Account Information
to = 'millerbott@gmail.com' # Email to send to. (Jack)
gmail_user = 'group39573@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'group39573columbia' # Gmail password.
